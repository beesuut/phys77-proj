...
from check_escape import baseline_escape
...
def reactor(count, u238, u235, boron, hw, reactorradius = 1):
    ...
    #all neutrons start with energy level of 1
    ...
    fcount, acount, scount, ecount = \
        baseline_escape(neutron, count, reactorradius, f_sa, f_ss, s_sa, s_ss, f_stot, s_stot, prpl_cs, n) \
